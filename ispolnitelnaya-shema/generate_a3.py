...
PIT_L, PIT_R, PIT_B = 41.5, 68.5, 122.0        # общая глубина 0,64 м
BET_B = 105.0                                  # бетон В25 П3, 0,30 м
PEN_B = 107.0                                  # утеплитель пеноплэкс, 0,04 м
SHB_B = 114.5                                  # щебень, 0,15 м; ниже песок 0,15 м
...
def main_view():
    ...
    o.append(dim_v(SHB_B, PIT_B, 38, "0,15м", ext_x=PIT_L, size=2.8, side=-1, alen=1.6))
    o.append(ln(PIT_L, Y0, 27.5, Y0, 0.15))
    o.append(ln(PIT_L, PIT_B, 27.5, PIT_B, 0.15))
    o.append(ln(30, Y0, 30, PIT_B, 0.2))
    o.append(arrow(30, Y0, 0, -1, L=2.2, half=0.7))
    o.append(arrow(30, PIT_B, 0, 1, L=2.2, half=0.7))
    o.append(txt(28.4, (Y0 + PIT_B) / 2, "0,64м", 2.8, rot=-90))
    o.append(leader([(52, 98), (80, 145)],
                    "Фундамент шлагбаума, бетон В25 П3, V = 0,329 м³, глубина 0,30 м", 2.9))
    o.append(leader([(64, 118), (80, 152)],
                    "Утеплитель пеноплэкс 40 мм, щебень 0,15 м, песок 0,15 м", 2.9))
...
NOTES = [
    ...
    "5. Фундамент шлагбаума выполнен на общую глубину 0,64 м — на 0,04 м ниже дна траншеи. Состав снизу вверх: песок 0,15 м, щебень 0,15 м,",
